...
const ShipmentInfo = ({ shipments }) => (
  <div>
    ...
    <div className="shipments__info" key={shipments.data.id}>
      <span className="tracking__num">
        Shipment No.
        {shipments.data.trackingNumber}
      </span>
      ...
      ) : shipments.data.state === 'DELIVERED_TO_SENDER'
        ? (
          <div className="lines">
            <hr className="line" />
            <hr className="line" />
